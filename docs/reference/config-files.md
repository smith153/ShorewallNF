...
| File | Purpose |
|------|---------|
| `params` | Variable definitions substituted into the other files during preprocessing. |
...
| `stoppedrules` | Admin-access rules that stay in force in the stopped safe state. |
