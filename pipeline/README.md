...
| Task Groomer | [`roles/task-groomer.md`](roles/task-groomer.md) | `type:task` or `type:pipeline`, `status:proposed` |
| Implementer | [`roles/implementer.md`](roles/implementer.md) | `type:task`/`type:pipeline`, `status:implementation-ready`, unassigned, unblocked |
